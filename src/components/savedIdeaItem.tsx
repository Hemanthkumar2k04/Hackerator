...
interface SavedIdeaItemProps {
  idea: any;
}

const SavedIdeaItem: React.FC<SavedIdeaItemProps> = ({ idea }) => {
  ...
  return (
    <div className="saved-idea-item">
      <div
        className="idea-name cursor-pointer font-bold text-lg py-2 px-4 hover:underline"
      ...
      <AnimatePresence>
        {expanded && (
          ...
          >
            <div className="w-full flex flex-col items-center bg-[#18181b] py-10">
